...
class SettingsServiceFactory extends pip_services_commons_node_1.Factory {
    constructor() {
        super();
...
SettingsServiceFactory.Descriptor = new pip_services_commons_node_2.Descriptor("pip-services-Settings", "factory", "default", "default", "1.0");
SettingsServiceFactory.MemoryPersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-settings", "persistence", "memory", "*", "1.0");
SettingsServiceFactory.FilePersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-settings", "persistence", "file", "*", "1.0");
SettingsServiceFactory.MongoDbPersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-settings", "persistence", "mongodb", "*", "1.0");
SettingsServiceFactory.ControllerDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-settings", "controller", "default", "*", "1.0");
SettingsServiceFactory.SenecaServiceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-settings", "service", "seneca", "*", "1.0");
SettingsServiceFactory.HttpServiceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-settings", "service", "http", "*", "1.0");
